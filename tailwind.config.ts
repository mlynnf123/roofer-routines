    ...
    extend: {
      colors: {
        ...
        sidebar: {
          ...
          "dark-hover": "hsl(var(--sidebar-dark-hover))",
        ...
        "workflow-node": {
          ...
          "condition-foreground": "hsl(var(--node-condition-foreground))",
          approved: "hsl(var(--node-approved))",
          "approved-foreground": "hsl(var(--node-approved-foreground))",
          step: "hsl(var(--node-step))",
          "step-foreground": "hsl(var(--node-step-foreground))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
